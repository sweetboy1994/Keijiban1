...
<div id="app">
	...
	<div class="limiter">
        ...
        <form action="/posts/edit" method="post" class="login100-form">
            {{ csrf_field()}}
            <div class="form-group">
                <textarea class="form-control" style="height:200px; width: 500px; margin-left: -98px; margin-top: -52px;" name="body" id="exampleFormControlTextarea1" rows="3">{{$post->body}}</textarea>
                @if ($errors->has('body'))
                <p class="error" style="text-align:center; color:#f4efef; font-weight:bold;">{{ $errors->first('body') }}</p>
                @endif
                <div class="text-center mt-3">
                    <input name="post_id" type="hidden" value="{{$post->id}}">
                    <input class="btn" style="cursor:pointer; font-weight: bold; background: #ffffff; color: #7955c9;" type="submit" value="編集する">
